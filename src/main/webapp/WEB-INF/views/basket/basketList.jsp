            ...
            <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
                ...
                <body>
                    ...
                    <section class="breadcrumb-section set-bg"
                        data-setbg="${ pageContext.request.contextPath }/resources/img/breadcrumb.jpg">
                        <div class="container">
                            <div class="row">
                                                            ...
                                                            <c:forEach var="b" items="${ selfList }">
                                                                ...
                                                                <tr>
                                                                    <td class="shoping_cart_no">
                                                                        ...
                                                                        <input type="hidden" class="hiddenBNum"
                                                                            name="bNum">
                                                                    </td>
                                                                    <td class="shoping__cart__item">
                                                                        <h5 class="productName"><b>${ b.PName }</b></h5>
                                                                        <input type="hidden" class="hiddenProductName"
                                                                            name="productName">
                                                                    </td>
                                                                    <td class="shoping__cart__price">
                                                                        <div style="display: inline-block;"
                                                                            class="proPrice">${ b.price }</div>
                                                                        <span>원</span>
                                                                    </td>
                                                                        ...
                                                                        <div class="quantity">
                                                                            <div>
                                                                                <input type="button" class="minus"
                                                                                    value=" - ">
                                                                                <input type="text" value="${ b.count }"
                                                                                    style="width:30px;" class="count">
                                                                                <input type="button" class="plus"
                                                                                    value=" + ">
                                                                                <input type="hidden" class="hiddenCount"
                                                                                    name="count">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td class="shoping__cart__total">
                                                                        <div class="innerTotal"
                                                                            ...
                                                                            b.count*b.price }</div><span>원</span>
                                                                        <input type="hidden" class="hiddenInnerTotal"
                                                                            name="innerTotal">
                                                                    </td>
                                                                    <td class="shoping__cart__item__close">
                                                                        <span class="icon_close sDelete"
                                                                            onclick="location.href='delete/${b.basketNum}'"></span>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                        </c:otherwise>
                                                            ...
                                                            <c:forEach var="p" items="${packageList }">
                                                                <tr>
                                                                    ...
                                                                    <td class="shoping__cart__total">
                                                                        <div class="innerTotal"
                                                                            style="display: inline-block;">
                                                                            ${p.count*p.price }</div><span>원</span>
                                                                        <input type="hidden" class="hiddenInnerTotal"
                                                                            name="innerTotal">
                                                                    </td>
                                                                    <td class="shoping__cart__item__close">
                                                                        <span class="icon_close pDelete"
                                                                            onclick="location.href='delete/${p.basketNum}'"></span>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                        </c:otherwise>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="shoping__cart__btns">
                                            <a href="${pageContext.request.contextPath}/main/main.do"
                                                class="primary-btn cart-btn">쇼핑 계속 하기</a>
                                        </div>
                                    </div>
                                    <!--쿠폰 div-->
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="shoping__checkout">
                                            ...
                                            <ul>
                                                <li>상품 가격 <span>
                                                        <div style="display: inline-block;" id="subSummary"
                                                            class="subSummary">0</div><span>원</span>
                                                    </span></li>
                                                <li>총 가격 <span>
                                            ...
                                            <c:choose>
                                                <c:when test="${empty selfList && empty packageList}">
                                                    <button type="submit" class="primary-btn" style="width: 100%;"
                                                        onclick="return setValue();" disabled>결제 하기</button>
                                                </c:when>
                                                <c:otherwise>
                                                    <button type="submit" class="primary-btn" style="width: 100%;"
                                                        onclick="return setValue();" id="payButton">결제 하기</button>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
