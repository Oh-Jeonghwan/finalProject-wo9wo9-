                    ...
                    <form action="checkout" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6">
                                ...
                                <div class="checkout__input">
                                    <p>주소<span>*</span></p>
                                    <input type="text" placeholder="기본 주소" class="도로명 주소" value="${m.address }">
                                    <br><br>
                                    <input type="text" placeholder="상세 주소" value="${m.detailAddress }">
                                </div>
                                <div class="checkout__input">
                                    <p>우편번호<span>*</span></p>
                                    <input type="text" value="${m.postNo }">
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="checkout__input">
                                            <p>핸드폰 번호<span>*</span></p>
                                            <input type="text" value="${m.phone }">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="checkout__input">
                            ...
                            <div class="col-lg-4 col-md-6" style="float:right">
                                <div class="checkout__order">
                                    <h4>주문 내역</h4>
                                    <div class="checkout__order__subtotal">합계 <span>${subSummary}<div
                                                style="display: inline-block;">원</div></span></div>
                                    <div class="checkout__order__products">할인가격
                                        <span>${subSummary-total}원&nbsp;</span></div>
                                    <div class="checkout__order__total">총 가격(할인 포함) <span>${total}<div
                                                style="display: inline-block;">원</div></span></div>
                                    ...
                                    <button type="submit" class="site-btn"
                                        onclick="return CheckForm()">결제하기</button>
        ...
        <script>
            $("#cardCheckBtn").click(function () {
                $.ajax({
                    ...
                    type: "post",
                    data: {
                        cardCom: $("#cardCom option:selected").val(),
                        cardPwd: $("#cardPwd").val()
                    },
