                ...
                <div class="row" style="margin-bottom: 50px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="banner__pic">
                            <img src="../resources/img/banner/banner-3.jpg" alt="" onclick="location.href='${pageContext.request.contextPath}/packagedo/category.do'">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="banner__pic">
                            <img src="../resources/img/banner/banner-4.jpg" alt="" onclick="location.href='${pageContext.request.contextPath}/selfdo/meal.do'">
                        </div>
                    </div>
                </div>
            </div>
